...
describe "::clear" do
  it "will remove all instances from the internal list of receipts (the class)" do
...
describe "::all" do
 ...
 # end
  ...
  r2 = Receipt.new("'J C Penny", "slacks", 1, "$30.00", "December 1, 1988")
...
before do
  ...
  it "saves the receipts in the csv file" do
    # we will need to read in the contents of our csv file and 
    # make sure they include the data we saved...So save the 
    Receipt.save_all("receipts_test.csv")
    # file then open the file and read it into memory, its a csv 
    ...
    # file so it should be tab separated ie 
    # 1:Macy's\tKhaki slacks\t3\t$35.00\tDecember 21, 1988
