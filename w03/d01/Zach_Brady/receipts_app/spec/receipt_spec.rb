...
describe "Receipt App" do
let(:receipt) {Receipt.new("Macy's", "Khaki slacks", 2, "$35.00", "December 21, 1988")}
  ...
  describe "an instance" do
    ...
    it "has a date that it was bought" do
  ...
  describe "#to_s" do
    ...
    it "returns a string with all the data" do 
      expect( receipt.to_s ).to eq("Receipt: Macy's, Khaki slacks, 2, $35.00, December 21, 1988")
    end
  end
  ...
  describe "::save_all" do
    ...
    it "saves the receipts in the CSV file" do
      ...
      # alright Zach, this one is tough! we will need to read in the contents of our CSV file, and make sure they they include the data we saved...
      ...
      #it's a TSV file! so it should be tab-separated, i.e. line 1 would look like:
      # Macy's\tKhaki slacks\t3\t$35.00\tDecember 21, 1998
