...
describe Receipt do 
  ...
  describe "an instance"
    ...
    it "has the date of purchase" do 
  ...
  describe "#to_s" do 
      ...
      describe"::clear" do
        it "remove all instances from the internal list of Receipt(the class)" do
          Receipt.new("JC Penny's", "Shirt", 4, "$25.00", "December 20, 1998") 
          Receipt.clear
      ...
      describe "::all" do 
        it "returns all of the instances " do 
          ...
          r1 = Receipt.new("JC Penny's", "Shirt", 4, "$25.00", "December 20, 1998") 
          r2 = Receipt.new("Macy's", "Khaki slacks", 3, "$35.00", "December 21, 1998") 
      ...
      describe "::save_all" do 
        ...
        it "saves the receipts in the CSV file" do 
          ...
          #read contents of CSV file and make sure that they include the data we saved
          #save the file, 
          Receipt.save_all("receipts_test.csv")
          ...
          # then it's a CSV file! so it should be tab-separated.  i.e. 1 = r1
          expect(first_line).to eq("JC Penny's\tShirt\t4\t$25.00\tDecember 20, 1998")
    ...
    # describe "#save" do
    #   it "saves the recept to the computer" do 
