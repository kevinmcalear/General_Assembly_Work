...
describe Receipt  do
  let(:receipt){Receipt.new("Macy's","Khanki slacks",3,"$35.00","December 21, 1998")}
  ...
  describe "an instance" do
    ...
    it "has an item name" do 
      expect( receipt.item).to eq("Khanki slacks")
    end
  ...
  describe "#to_s" do
    ...
    it "returns a string with all the data" do
      ...
      expect( receipt.to_s).to eq("Receipt: Macy's, Khanki slacks, 3, $35.00, December 21, 1998")
    end
  end

  describe "::all" do
    # before do
    #   r1 = Receipt.new("Macy's","Khanki slacks",3,"$35.00","December 21, 1998")
