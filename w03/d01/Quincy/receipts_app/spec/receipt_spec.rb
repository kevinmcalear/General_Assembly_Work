...
describe Receipt do
  ...
  describe "::save_all" do
    ...
    it "it creates a CSV file if none exist" do
      Receipt.clear
    ...
    it "saves the receipts in the csv file" do
      ...
      # alright Q, this one is TOUGH! We will need to read in the contents of our CSV file, and make sre they include the data we saved...

      # so save the file
      Receipt.save_all("receipts_test.csv")
      # then open the file and read it in to memory
      contents = File.open("receipts_test.csv")

      # its a CSV file! so it should be comma-seperated: ie
