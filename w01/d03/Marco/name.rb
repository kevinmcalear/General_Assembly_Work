...
num1 = $firstnamelist.index("Bumblebee")
puts $firstnamelist[num1]




$firstnamelist.push("Jeff")
num2 = $firstnamelist.index("Jeff")
puts $firstnamelist[num2]




num3 = $firstnamelist.index("Muffintop")
$firstnamelist.delete_at(num3)
puts $firstnamelist[num3]



num4 = $lastnamelist.index("Gigglesnort")
puts $lastnamelist[num4]
