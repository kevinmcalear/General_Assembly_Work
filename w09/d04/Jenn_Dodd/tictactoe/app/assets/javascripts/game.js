...
Game.prototype.endGame = function() {
  if (this.winner !== undefined) {
    alert(this.winner.toUpperCase() + " won!");
    $.post("/games", {won: this.winner});
  }
...
Game.prototype.updateStats = function() {
  $.getJSON("/games/stats", function(response) {
    var xwins = response.x;
    var owins = response.o;
    var ties = response.tie;
    $("span.x-win").text("X wins: " + xwins);
    $("span.o-win").text("O wins: " + owins);
    $("span.tie").text("Ties: " + ties);
  });
}
