...
# we do not initialize the class with a renter. Rather we create a method that allows us to eventually add a renter? 
  ...
  def add_renter
    ...
    gender = gets.chomp
  #clarify these two lines. Are we setting the above defined renter to renter or is this a new variable?
    renter = Person.new(name,age,gender)
    self.renter=(renter)
  # we are setting this renter to equal a new instance of renter? where does this go?
...
class Building
  ...
  #same as new renter. 
    ...
    self.apartments().push(apartment) #@apartments.push(apartment)
  end
...
# where does press enter to continue come from?
