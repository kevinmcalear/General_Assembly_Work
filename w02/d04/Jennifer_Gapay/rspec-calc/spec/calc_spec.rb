...
describe Calculator do
  ...
  describe "#sum" do
    ...
    it "computes the sum of an array of one number"
      expect(Calculator.new[2]).to eq(2)
    end
    ...
    it "computes the sum of an array of many numbers"
      expect(Calculator.new.sum([1, 2, 3, 4]).to eq(10)
  end

  describe "#multiply" do 
    it "multiplies two numbers" do
      expect(Calculator.new.multiply(4, 2)).to eq(8)
    end
    it "multiplies several numbers" do
      expect( Calculator.new.multiply(2, 3, 4, 5)).to eq(12)
  end
end
  ...
  describe "#factorial" do
    ...
    it "computes the factorial of 2" do
      expect(Calculator.new.factorial(2) ).to eq(1)
    end
    it "computes the factorial of 5" do
      expect(Calculator.new.factorial(5) ).to eq(1)
    end
    it "computes the factorial of 10" do
        expect(Calculator.new.factorial(10) ).to eq(1)
      end
  end
