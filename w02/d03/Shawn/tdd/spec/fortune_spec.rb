...
describe FortuneCookie  do 
  ...
  describe "::new" do # the '::' denotes a class method, whereas '#' denotes an instancce method
  ...
  describe "#read" do #The method we're describing goes here
    context "still wrapped" do 
     ...
     context "the cookie is unwrapped" do 
      before { fortune.unwrap! }
