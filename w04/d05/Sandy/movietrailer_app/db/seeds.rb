...
# # # character = Movie.find_by(name: "500 Days of Summer")
# Character.create(
#   name: "Tom",
...
# Trailer.create(
#   title: "500 Days of Summer",
#   embed_url: "http://www.youtube.com/watch?v=PsD0NpFSADM",
#   movie_id: 16)
...
# Trailer.create(
#   title: "Beginners",
#   embed_url: "http://www.youtube.com/watch?v=rXUFUp6vsxg",
#   movie_id: 17)
...
# Trailer.create(
#   title: "Side Effects",
#   embed_url: "http://www.youtube.com/watch?v=8R9H87zafc0",
#   movie_id: 18)
