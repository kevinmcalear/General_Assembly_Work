...
describe Word do
  ...
  describe "#reverse_words" do
    it "reverses the words" do
        expect(Word.new.reverse_words("We are never ever ever getting back together" )).to eq("together back getting ever ever never are We")
    end
  end
  ...
  describe "#reverse_each_word" do
    it "reverses each word" do
        expect(Word.new.reverse_each_word ("We are never ever ever getting back together" )).to eq("eW era reven reve reve gnitteg kcab rehtegot")
    end
  end
end